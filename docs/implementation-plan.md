...
> 状态：M0 至 M4 已合入 `main`；M5-1 至 M5-5 已实现，位于 `m5/migration-orchestration`
> 核验日期：2026-09-24
...
| M5 迁移编排 | M5-1 至 M5-5 已实现 | 只读 CLI、dry-run、manifest、resume、真实 import/verify、显式替换与 rollback；真实已登录 renderer 端到端待验收 |
