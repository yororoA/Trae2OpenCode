const translations = {
  zh: {
    ...
    "compatibility.note": "表中 OpenCode 版本为已验证基线；其他稳定 1.x/2.x 需使用同版本 CLI，通过协议及隔离往返验证后才能迁移。",
  ...
  en: {
    ...
    "compatibility.note": "Listed OpenCode versions are verified baselines. Other stable 1.x/2.x releases need a CLI matching the server version and must pass protocol and isolated round-trip checks before migration.",
