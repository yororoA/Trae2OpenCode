const translations = {
  zh: {
    ...
    "hero.description": "一条命令迁移消息、推理与工具调用。自动识别 OpenCode v1/v2 协议，支持中断续跑，并在写入后逐项回读核验。",
    "hero.start": "在 GitHub 获取",
    "hero.source": "查看使用方式",
    "proof.command": "条命令完成迁移",
    "proof.platforms": "本机 TRAE 来源读取",
    "proof.protocols": "双协议目标适配",
    ...
    "compatibility.note": "OpenCode v1 当前仅验证 1.17.9 与 1.18.32 两个版本，不表示两者之间的所有版本均受支持。",
  ...
  en: {
    ...
    "hero.description": "Migrate messages, reasoning, and tool calls with one command. OpenCode v1/v2 is detected automatically, interrupted runs resume safely, and every write is verified.",
    ...
    "proof.protocols": "target protocol adapters",
    ...
    "compatibility.note": "OpenCode v1 verification covers exactly 1.17.9 and 1.18.32; intermediate releases are not implicitly supported.",
