const translations = {
  zh: {
    ...
    "compatibility.probe": "稳定版本自动检测",
    "compatibility.upgrade": "提示升级",
    "compatibility.platform": "本机来源读取",
    "compatibility.offline": "Linux 仅导入 bundle",
    "compatibility.note": "OpenCode v1 基线为 1.17.9 与 1.18.32；其他稳定版本需通过协议及隔离往返验证。",
  ...
  en: {
    ...
    "compatibility.probe": "Stable releases probed",
    ...
    "compatibility.note": "OpenCode v1 baselines are 1.17.9 and 1.18.32. Other stable releases require protocol and isolated round-trip checks.",
