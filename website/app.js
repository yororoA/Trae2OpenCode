const translations = {
  zh: {
    ...
    "nav.capabilities": "能力",
    "nav.quickstart": "开始使用",
    "hero.eyebrow": "开源 · 本地优先 · 可验证",
    "hero.statement": "把 TRAE 会话，完整带到 OpenCode。",
    "hero.description": "一条命令迁移消息、推理与工具调用。自动脱敏，支持中断续跑，并在写入后逐项回读核验。",
    "hero.start": "开始迁移",
    "hero.source": "查看源码",
    "proof.command": "条命令完成迁移",
    "proof.tests": "项自动化测试",
    "proof.versions": "已验证 OpenCode 版本",
    ...
    "capabilities.safetyText": "自动剥离已识别凭据；无法证明归属的目标、未知版本与不完整写入都会停止。",
    ...
    "quickstart.stepTwoText": "打开包含目标会话的项目窗口。",
    ...
    "compatibility.title": "只迁移经过验证的组合",
    "compatibility.component": "组件",
    "compatibility.supported": "已验证范围",
    "compatibility.behavior": "超出范围",
  ...
  en: {
    ...
    "hero.eyebrow": "Open source · Local first · Verifiable",
    "hero.statement": "Bring your TRAE sessions to OpenCode, intact.",
    "hero.description": "Migrate messages, reasoning, and tool calls with one command. Secrets are redacted, interrupted runs resume safely, and every write is read back and verified.",
    "hero.start": "Start migrating",
    "hero.source": "View source",
    "proof.command": "command to migrate",
    "proof.tests": "automated tests",
    "proof.versions": "verified OpenCode versions",
    ...
    "capabilities.safetyText": "Detected secrets are removed. Unknown versions, unowned targets, and incomplete writes stop safely.",
    ...
    "quickstart.stepTwoText": "Open the project window that contains the target sessions.",
    ...
    "compatibility.title": "Only verified combinations are migrated",
    "compatibility.component": "Component",
    "compatibility.supported": "Verified range",
    "compatibility.behavior": "Outside range",
...
const demoLines = {
  zh: [
    ...
    { text: "✓ OpenCode 2.0.16 协议与 schema 已验证", kind: "success" },
  ...
  en: [
    ...
    { text: "✓ OpenCode 2.0.16 protocol and schema verified", kind: "success" },
